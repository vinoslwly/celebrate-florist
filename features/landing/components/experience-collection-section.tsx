    ...
    >
      <div className="mx-auto max-w-6xl">
        <SectionHeading
          ...
          subtitle="Lima suasana, masing-masing punya karakter sendiri — contoh gambar menyusul ya ✨"
        />
              ...
              <div className="flex flex-col gap-4 rounded-3xl border border-pink-soft/40 bg-card p-5 shadow-soft">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <PhotoSlot
                    ...
                    alt={`${theme.name} greeting preview`}
                  ...
                  <PhotoSlot
                    ...
                    alt={`${theme.name} photobooth strip example`}
