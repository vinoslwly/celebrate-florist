  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        transition={{ delay: reduceMotion ? 0 : 0.5, duration: 0.7 }}
      />
      ...
      {!reduceMotion ? (
        <motion.div
          ...
          transition={{ delay: 1.05, duration: 1.05, ease: EASE_OUT }}
        />
      ) : null}
          ...
          {reduceMotion ? (
            ...
            <>
              <motion.div
                ...
                transition={{ delay: 0.75, duration: 0.25, ease: EASE_OUT }}
              >
