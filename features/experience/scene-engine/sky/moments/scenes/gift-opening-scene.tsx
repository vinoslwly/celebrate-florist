...
/** Connection Scene 2 reuse — three failed open taps, then advance. */
 ...
 *
 * `lockedOnly` — Sky Connection Scene 2: wrapped gift only; three failed
 * open taps (shake, no letter), then advances via onComplete (Bloom pattern).
 */
