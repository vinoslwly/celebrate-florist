...
/** Ambient fall — few petals, transform/opacity only (mobile-light). */
...
/** One-shot entrance burst — celebrates the unlock invite, then gone. */
const BURST_PETALS = [
...
/**
 * connection.challenge-invitation — living recreation of Founder Scene 3.
 * Warm invitation card; celebratory but mobile-light entrance; I'm Ready → quiz.
 */
export function ConnectionChallengeInvitationScene({
  onComplete,
  ...
  return (
    <div className="relative flex h-full min-h-0 w-full flex-1 flex-col overflow-x-clip overflow-y-auto overscroll-y-contain touch-pan-y [-webkit-overflow-scrolling:touch] bg-[#F8E4E7]">
      ...
      <motion.div
        aria-hidden
        className="pointer-events-none absolute top-4 right-4 sm:top-6 sm:right-8"
      ...
      <div className="relative z-10 flex min-h-full w-full flex-col items-center justify-center px-5 py-10 sm:px-8">
        <div className="relative w-full max-w-[20.5rem] sm:max-w-[22rem]">
          {/* Soft celebration bloom — opacity/scale only */}
          <motion.div
            aria-hidden
          ...
          {/* One-shot petal burst around the card */}
          <div
            aria-hidden
          ...
          <div className="relative z-10">
            ...
            >
              ...
              >
                <motion.p
                  variants={fadeUp}
                  className="relative text-center text-[10px] font-semibold tracking-[0.28em] text-[#E39AB0] uppercase sm:text-[11px]"
                >
                  Special Message
                </motion.p>
                ...
                <motion.h2
                  variants={fadeUp}
                  className="relative mt-4 text-center font-serif text-[1.35rem] leading-snug font-semibold text-[#6B2A38] sm:text-[1.55rem]"
                >
                  Someone prepared a little challenge for you.
                </motion.h2>

                <motion.p
                  variants={fadeUp}
                  className="relative mt-3 text-center text-sm leading-relaxed text-[#D07090] sm:text-[15px]"
                >
                  Complete it and something special will be waiting.
                </motion.p>
                ...
                <motion.div variants={fadeUp}>
                  <motion.button
                    type="button"
                    onClick={onComplete}
                    className="relative mt-7 flex w-full items-center justify-center gap-2 rounded-full bg-[#E8799A] px-5 py-3.5 text-sm font-bold tracking-[0.14em] text-white uppercase shadow-[0_10px_24px_-10px_rgba(180,60,100,0.55)] focus-visible:ring-2 focus-visible:ring-[#C45B7A] focus-visible:ring-offset-2 focus-visible:outline-none sm:text-[15px]"
                    initial={{ scale: 0.94 }}
