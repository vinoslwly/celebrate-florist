...
/** Anonymous Theme Lab fixtures — Warm Memories; not real customer data. */
export const WARM_MEMORIES_LAB_EXPERIENCE = {
  id: "theme-lab-warm-memories",
  order_id: "theme-lab-order-warm-memories",
  theme_id: "warm",
  experience_token: "theme-lab-warm-memories",
  greeting_name: "Alex",
  closing_name: "Jordan",
...
/** Reuse Warm Moments gallery stand-ins for later Memories gallery scenes. */
export const WARM_MEMORIES_LAB_PHOTOS: PublishedPhoto[] =
  WARM_MOMENTS_LAB_PHOTOS;

/** One memory screen — photo first, three story options. */
export type WarmMemoriesLabStoryOption = {
  title: string;
  body: string;
  sortOrder: number;
};

export type WarmMemoriesLabMatchPair = {
  photoSortOrder: number;
  photoSignedUrl: string;
  photoAlt: string;
  storyOptions: [
    WarmMemoriesLabStoryOption,
    WarmMemoriesLabStoryOption,
    WarmMemoriesLabStoryOption,
  ];
};

export type WarmMemoriesLabMatch = {
  pairs: WarmMemoriesLabMatchPair[];
};
 ...
 */
export const WARM_MEMORIES_LAB_MATCH: WarmMemoriesLabMatch = {
  pairs: [
    {
      photoSortOrder: 0,
      photoSignedUrl: "/themes/bloom/moments/gallery-fixtures/coffee.webp",
      photoAlt: "A warm letter moment",
      storyOptions: [
        {
          sortOrder: 0,
          title: "Kado Surat",
...
export type WarmMemoriesLabScoreResult = {
  percent: number;
  headline: string;
  message: string;
};

export const WARM_MEMORIES_LAB_SCORE_RESULT: WarmMemoriesLabScoreResult = {
  percent: 92,
