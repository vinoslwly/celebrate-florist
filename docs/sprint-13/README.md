...
> **Implementation:** ✅ P0 · 12-host fade · RM/interactive P2 · representative gift ceremony · [02](./02_MOTION_FOUNDATION_AND_HOST_PILOT.md) · [03](./03_HOST_TRANSITION_EXPANSION_AND_RM_FIX.md) · [04](./04_FOCUSED_RM_AND_INTERACTIVE_MOTION_PASS.md) · [05](./05_REPRESENTATIVE_GIFT_ENVELOPE_CEREMONY.md) · letter/gallery not started  
...
> **`npm audit` baseline:** 10 (7 high, 3 moderate) — no `npm audit fix --force`

## Goal

Make the website feel like an experience, not a collection of static pages — via a **minimal** motion foundation and representative Theme Lab polish.
