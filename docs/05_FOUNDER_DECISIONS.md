...
### FD-S12-18 — Bloom Connection Pilot; Scene 0–1 Reuse Moments 🔄 IN PROGRESS

|              |                                                                                                                                                                                                                                                                                                                                     |
| ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Date**     | 2026-07-20                                                                                                                                                                                                                                                                                                                          |
| **Decision** | Bloom Connection Theme Lab is started. Scene 0 and Scene 1 match locked Moments (loading + gift flower introduction) — no new Founder images required for those scenes. Later Connection scenes await one reference image at a time. Production `/e/` Scene Engine wiring remains unauthorized. Memories and Treasures not started. |
