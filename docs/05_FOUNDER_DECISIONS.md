...
|              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Decision** | Official Connection presentation scene graph: Scenes **0–15** (Celebrate Loading → Gift Introduction → Locked Gift → Challenge Invitation → Quiz Transition → Quiz Introduction → parameterized Quiz questions → Score Calculation → Score Reveal → Celebration Transition → **Letter Emergence** → Letter Reveal → Gallery Unlock → Gallery → Gallery Ending → Photobooth). Locked Gift reveals nothing (CF-4). Scene 10 shows To/From letter head only (no tap CTA); full letter body is Scene 11. One question per screen; no back navigation; batch submit after last answer. Use **"gift"** not **"letter"** until Letter Emergence/Reveal. Score tone warm/celebratory (CF-1). |
| **Spec**     | [sprint-11/02_CONNECTION_SCENE_ARCHITECTURE.md](./sprint-11/02_CONNECTION_SCENE_ARCHITECTURE.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| **Note**     | Doc 13 business journey (Quiz → Submit → Score + Band → Letter → Gallery → Photobooth) preserved; ceremony scenes are presentation layer only. Unlock restore → Scene 8 via sessionStorage (CF-2). **Revised 2026-07-21:** Founder inserted Scene 10 Letter Emergence; former Scenes 10–14 renumbered 11–15.                                                                                                                                                                                                                                                                                                                                                                         |
...
### FD-S12-18 — Bloom Connection Pilot; Scene 0–1 Reuse Moments 🔒 SUPERSEDED BY LOCK

|              |                                                                                                                                                                                                                                                  |
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Date**     | 2026-07-20 (start) · Connection locked 2026-07-21                                                                                                                                                                                                |
| **Decision** | Bloom Connection Theme Lab started with Scene 0–1 Moments reuse. Connection Scenes 0–15 later completed and locked ([04 audit](./sprint-12-5/04_BLOOM_CONNECTION_AUDIT_AND_LOCK.md)). Production `/e/` Scene Engine wiring remains unauthorized. |
| **Register** | [DDR-S12-035](./sprint-12/CELEBRATE_DESIGN_DECISION_REGISTER.md)                                                                                                                                                                                 |
| **Docs**     | [sprint-12-5/README.md](./sprint-12-5/README.md) · [02_CONNECTION_SCENE_ARCHITECTURE.md](./sprint-11/02_CONNECTION_SCENE_ARCHITECTURE.md)                                                                                                        |

### FD-S12-19 — Full Bloom Theme Locked 🔒 APPROVED

|              |                                                                                                                                                                                                                                                                                                   |
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Date**     | 2026-07-21                                                                                                                                                                                                                                                                                        |
| **Decision** | Bloom Theme Lab is **APPROVED AND LOCKED** as a complete theme (Moments · Connection · Memories · Treasures) after independent full audit. Warm / Playful / Sky **not started** — await Founder approval to begin next theme. Production Scene Engine and `/e/[token]` remain **NOT AUTHORIZED**. |
...
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Date**     | 2026-07-23                                                                                                                                                                                                                                                                                                                                        |
| **Decision** | Warm Theme Lab is **APPROVED AND LOCKED** as a complete theme (Moments · Connection · Memories · Treasures) after independent full audit. Limited Warm typography exception documented. **Playful** authorized as next theme after push (`6a6f0cd`). **Sky** **NOT STARTED**. Production Scene Engine and `/e/[token]` remain **NOT AUTHORIZED**. |
...
### FD-S12-22 — Full Sky Locked; Playful Frozen; Three-Theme Release Scope 🔒 APPROVED

|              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Date**     | 2026-08-04                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **Decision** | Full Sky Theme Lab is **APPROVED AND LOCKED** ([23 audit](./sprint-12-5/23_FULL_SKY_THEME_AUDIT_AND_LOCK.md), commit `43c65f3`). **Playful is FROZEN** — no implementation, assets, routes, fixtures, or exploration without a future Founder unlock. Active release scope is **Bloom · Warm · Sky** only (**3 themes × 4 modes**). This is a **delivery decision** to prioritize publication, not a rejection of Playful’s concept; future Playful work belongs in a **post-publication** phase. Production `/e/[token]` Scene Engine remains **NOT AUTHORIZED**. |
| **Register** | [DDR-S12-041](./sprint-12/CELEBRATE_DESIGN_DECISION_REGISTER.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| **Docs**     | [23_FULL_SKY_THEME_AUDIT_AND_LOCK.md](./sprint-12-5/23_FULL_SKY_THEME_AUDIT_AND_LOCK.md) · [24_SPRINT_12_5_FINAL_CLOSURE_AUDIT.md](./sprint-12-5/24_SPRINT_12_5_FINAL_CLOSURE_AUDIT.md) · [sprint-12-5/README.md](./sprint-12-5/README.md)                                                                                                                                                                                                                                                                                                                         |

### FD-S12-23 — Sprint 12.5 Theme Lab Milestone Closed 🔒 APPROVED

|              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Date**     | 2026-08-04                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| **Decision** | Sprint 12.5 Final Closure Audit ([24](./sprint-12-5/24_SPRINT_12_5_FINAL_CLOSURE_AUDIT.md), commit `9e380a8`) is **APPROVED**. Theme Lab milestone **CLOSED**. Bloom · Warm · Sky remain **LOCKED**. Playful · Pure remain **FROZEN**. Release scope remains **3 × 4**. Catalog sync (Playful not selectable for new orders) stands. Sprint 13 **NOT STARTED** — requires separate Founder authorization after push. Production `/e/[token]` Scene Engine remains **NOT AUTHORIZED**. Do not run `npm audit fix --force`. |
| **Docs**     | [24_SPRINT_12_5_FINAL_CLOSURE_AUDIT.md](./sprint-12-5/24_SPRINT_12_5_FINAL_CLOSURE_AUDIT.md) · [sprint-12-5/README.md](./sprint-12-5/README.md)                                                                                                                                                                                                                                                                                                                                                                           |
